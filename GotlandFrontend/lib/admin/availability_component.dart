...
@Component(
    selector: 'availability-component', templateUrl: 'availability_component.html', styleUrls: ['../content/content_styles.css', 'availability_component.css'], directives: <dynamic>[coreDirectives, MaterialProgressComponent, SpinnerWidget])
