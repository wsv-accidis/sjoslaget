...
@Component(
    ...
    providers: <dynamic>[BookingValidator, ClientFactory, ExternalBookingRepository],
    directives: <dynamic>[routerDirectives])
class ExternalComponent {
  final List<RouteDefinition> routes = [RouteDefinition(routePath: ExternalRoutes.createBooking, component: ExternalBookingPageNgFactory)];
}
