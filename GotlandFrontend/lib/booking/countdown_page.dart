...
class CountdownPage implements OnInit, OnDestroy {
	...
	static const List<String> BUTTON_TEXT = <String>[
		...
		'Zzzzzzz...',
		'Nu till några roliga fakta om livet',
		'Fem myror är fler än fyra elefanter',
		'Din katt vill förmodligen äta upp dig',
		'Pengarna räcker längre om man inte super...',
		'Men vem bryr sig?',
		...
		'Tack för visat samförstånd.',
		'Det kanske inte är så viktigt hur AG en gång blev till...',
		'...som hur det kommer att bli i framtiden?',
		'Har du tänkt på hur det skulle kännas att vara en hund?',
		...
		'Seriöst, vem använder margarin när det finns smör?',
		...
		'Är Varm och Kall fortfarande en grej?'
	];
