class ValueComparer {
  ...
  static int compareStringPairIgnoreCase(
      String a1, String a2, String b1, String b2) {
    return compareStringPair(
        a1.toLowerCase(), a2.toLowerCase(), b1.toLowerCase(), b2.toLowerCase());
  }
  ...
  static String _normalizeNumbers(String str) => str.replaceAllMapped(
      RegExp(r'(\s|^)([0-9])([a-z]|\s|$)'), (m) => '${m[1]}0${m[2]}${m[3]}');
}
