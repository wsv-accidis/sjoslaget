...
class BookingCabinsPage implements OnInit {
  ...
  Future<void> ngOnInit() async {
    if (window.sessionStorage.containsKey(BookingComponent.BOOKING)) {
      ...
      if (!cabins.readOnly) cabins.validateAll();
  ...
  Future<void> saveBooking() async {
    ...
    try {
      ...
      if (null != bookingResult && isNotEmpty(bookingResult.password) && isEmpty(result.password)) result.password = bookingResult.password;
