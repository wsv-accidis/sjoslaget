...
import 'about_contact_page.template.dart';
...
@Component(selector: 'about-page', styleUrls: ['content_styles.css'], template: '''
...
class AboutComponent {
  final List<RouteDefinition> routes = [
    ...
    RouteDefinition(routePath: AboutRoutes.contact, component: ContactPageNgFactory),
