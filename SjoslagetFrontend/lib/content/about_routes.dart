...
class AboutRoutes {
  static final RoutePath start = RoutePath(path: 'sjoslaget', useAsDefault: true, parent: ContentRoutes.about);
  static final RoutePath booking = RoutePath(path: 'bokning', parent: ContentRoutes.about);
  static final RoutePath contact = RoutePath(path: 'kontakt', parent: ContentRoutes.about);
