...
class BookingOverviewItem extends BookingPaymentModel {
	...
	BookingOverviewItem(this.reference, this.firstName, this.lastName, this.lunch, Decimal totalPrice, Decimal amountPaid, this.numberOfCabins, this.isLocked, this.updated)
