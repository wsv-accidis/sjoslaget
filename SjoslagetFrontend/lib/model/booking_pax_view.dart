...
class BookingPaxView {
  ...
  BookingPaxView.copy(BookingPaxView source)
      : group = source.group,
        ...
        requiredRow = source.requiredRow {
    clearErrors();
  }
  ...
  BookingPax toBookingPax() => BookingPax(group, firstName, lastName, gender, dob, nationality, _toInt(years));
